...
function gameTime() {
    _gameTimeNum--;
    if (_gameTimeNum <= 0) {
        GameTimeLayer.innerHTML = '&nbsp;&nbsp;&nbsp;&nbsp;Time is up!!!';
        gameOver();
...
function shareText(score) {
    ...
    SubmitResults();
    if (score <= 30) return 'TaiCaiLe';
    if (score <= 60) return 'TaiZhaLe';
    if (score <= 100) return 'TaiXunLe';
    if (score <= 150) return 'ZhenBuChuo';
    return 'Are You Jiacheng？';
}
